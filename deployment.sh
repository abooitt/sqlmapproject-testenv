...
APT_INST='aptitude install -y'

echo "### Installing Apache, PHP, git and generic PHP modules"
$APT_INST apache2 libapache2-mod-php5 git php5-dev php5-gd php-pear php5-mysql php5-pgsql php5-sqlite php5-interbase php5-sybase php5-odbc libmdbodbc1 unzip make libaio1 bc screen htop git subversion sqlite sqlite3
...
echo "### Downloading sqlmap test environment to $DOCROOT"
cd $DOCROOT
git clone https://github.com/sqlmapproject/testenv.git sqlmap

$APT_INST debconf-utils
...
# find the version of server package to be installed
MYSQL_SERVER_PKG=$(apt-get -s install mysql-server | grep -o 'mysql-server-[0-9][^ ]*' | sort -u)
# set debconf selections
echo $MYSQL_SERVER_PKG mysql-server/root_password password $PASS | debconf-set-selections
echo $MYSQL_SERVER_PKG mysql-server/root_password_again password $PASS | debconf-set-selections

$APT_INST mysql-client mysql-server libmysqlclient-dev libmysqld-dev
...
$APT_INST postgresql-client postgresql postgresql-server-dev-all libpq-dev 
...
su - postgres -c "psql -c \"ALTER USER postgres WITH PASSWORD 'testpass';\""
echo "postgres:$PASS" | chpasswd
echo "*:*:*:postgres:$PASS" > /root/.pgpass
chmod 600 /root/.pgpass
psql -U postgres -h 127.0.0.1 -c "CREATE DATABASE testdb;"
psql -U postgres -h 127.0.0.1 -d testdb -f $DOCROOT/sqlmap/schema/pgsql.sql
echo "host    all         all         0.0.0.0/0          md5" >> /etc/postgresql/*/main/pg_hba.conf
sed -i "s/listen_addresses = 'localhost'/listen_addresses = '*'/g" /etc/postgresql/*/main/postgresql.conf
sed -i "s/#listen_addresses = /listen_addresses = /g" /etc/postgresql/*/main/postgresql.conf
service postgresql restart

#echo "### Configuring PHP for SQLite 1"
...
#make
#make install
#echo "extension=sqlite.so" > /etc/php5/conf.d/99-sqlite1.ini
#
...
#chmod 666 $DOCROOT/sqlmap/dbs/firebird/testdb.fdb
#
...
#@$DOCROOT/sqlmap/schema/oracle.sql;
...
#su -c "/opt/ibm/db2/V9.5/bin/db2 < $DOCROOT/sqlmap/schema/db2.sql" db2inst1
#
...
#dbaccessdemo7
#isql inf -v < $DOCROOT/sqlmap/schema/informix.sql
#
...
#Driver      = MDBToolsODBC
#Database    = $DOCROOT/sqlmap/dbs/access/testdb.mdb
...
cd /tmp
apt-get install -y tomcat7 default-jdk
chown -R tomcat7 /var/lib/tomcat7/
cp -r $DOCROOT/sqlmap/hsqldb/ /var/lib/tomcat7/webapps/hsqldb_1_7_2
cp -r $DOCROOT/sqlmap/hsqldb/ /var/lib/tomcat7/webapps/hsqldb_2_2_9

echo "### Compiling Java for HSQLDB testbed"
mkdir /var/lib/tomcat7/webapps/hsqldb_1_7_2/WEB-INF/classes/
javac -classpath /usr/share/tomcat7/lib/servlet-api.jar $DOCROOT/sqlmap/hsqldb/src/*.java
mv -f $DOCROOT/sqlmap/hsqldb/src/*.class /var/lib/tomcat7/webapps/hsqldb_1_7_2/WEB-INF/classes/
...
sed -i -e 's/org.hsqldb.jdbcDriver/org.hsqldb.jdbc.JDBCDriver/' $DOCROOT/sqlmap/hsqldb/src/Register.java
sed -i -e 's/org.hsqldb.jdbcDriver/org.hsqldb.jdbc.JDBCDriver/' $DOCROOT/sqlmap/hsqldb/src/ViewRecords.java
sed -i -e 's/jdbc:hsqldb:hsqldb-1_7_2/jdbc:hsqldb:hsqldb-2_2_9/' $DOCROOT/sqlmap/hsqldb/src/Register.java
sed -i -e 's/jdbc:hsqldb:hsqldb-1_7_2/jdbc:hsqldb:hsqldb-2_2_9/' $DOCROOT/sqlmap/hsqldb/src/ViewRecords.java
javac -classpath /usr/share/tomcat7/lib/servlet-api.jar $DOCROOT/sqlmap/hsqldb/src/*.java
mv -f $DOCROOT/sqlmap/hsqldb/src/*.class /var/lib/tomcat7/webapps/hsqldb_2_2_9/WEB-INF/classes/
...
$APT_INST python-setuptools python-dev python-kinterbasdb python-pymssql python-psycopg2 python-pyodbc python-pymssql python-sqlite python-impacket python-jpype
...
alias db2conn='db2'
alias sqliteconn='sqlite $DOCROOT/sqlmap/dbs/sqlite/testdb.sqlite'
alias sqlite3conn='sqlite3 $DOCROOT/sqlmap/dbs/sqlite/testdb.sqlite3'
alias firebirdconn='isql-fb -u SYSDBA -p testpass $DOCROOT/sqlmap/dbs/firebird/testdb.fdb'
...
alias sqliteconnsqlmap='python /opt/sqlmap/sqlmap.py -d sqlite://$DOCROOT/sqlmap/dbs/sqlite/testdb.sqlite -b --sql-shell -v 6'
alias sqlite3connsqlmap='python /opt/sqlmap/sqlmap.py -d sqlite3://$DOCROOT/sqlmap/dbs/sqlite/testdb.sqlite3 -b --sql-shell -v 6'
alias firebirdconnsqlmap='python /opt/sqlmap/sqlmap.py -d firebird://SYSDBA:testpass@$DOCROOT/sqlmap/dbs/firebird/testdb.fdb -b --sql-shell -v 6'
alias accessconnsqlmap='python /opt/sqlmap/sqlmap.py -d access://$DOCROOT/sqlmap/dbs/access/testdb.mdb -b --sql-shell -v 6'
